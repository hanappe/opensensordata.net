...
?><html>
  ...
  <body>
    <p>Your email and account have been validated (yeah!).</p>
    <p>Your account key is <?php echo "'$account->key'" ?> (without the
    quotes). You will need to use the OpenSensorData.net services.</p>
  </body>
</html>
